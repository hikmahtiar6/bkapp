...
var OLLatLonPicker = (function () {
    ...
    var setMarkerMap = function (lat_MapProjection, lng_MapProjection, zoom) {
        ...
        var icon = new OpenLayers.Icon('http://kominfo.kotabogor.go.id/asset/images/web/IMAGES/logo/icon-map-point-large.png', size, offset);
    ...
    var publicfunc = {
        ...
        init:function (object) {
            ...
            defZoom = $(_self.vars.form).find(".gllpZoom").val() ? parseInt($(_self.vars.form).find(".gllpZoom").val()) : 13;
